...
\begin{frame}{Áreas de Influência}
    \begin{columns}
        % Coluna 1: Texto
        \begin{column}{0.5\textwidth}
            \includegraphics[width=\textwidth]{plots/acessibilidade_teorica_leitos.png} 
        \end{column}

        % Coluna 2: Figura
        \begin{column}{0.5\textwidth}
            \includegraphics[width=\textwidth]{plots/acessibilidade_real_leitos.png} 
        \end{column}
    \end{columns}
\end{frame}

\begin{frame}{Áreas de Influência}
    \includegraphics[width=\textwidth]{plots/corr_both.png} 
\end{frame}
